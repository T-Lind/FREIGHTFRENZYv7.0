 ...
 */
public class RoadrunnerWrapperPS {
    /**
     ...
     */
    public SequenceWrapperPS sequenceWrapperPS;
     ...
     */
    public RoadrunnerWrapperPS(HardwareMap hardwareMap) {
     ...
     */
    public RoadrunnerWrapperPS(HardwareMap hardwareMap, RoadrunnerUnit unit) {
        drivetrain = new SampleMecanumDrive(hardwareMap);
        this.unit = unit;
        startPose = new Pose2d(0, 0, 0);
    }
     ...
     */
    public RoadrunnerWrapperPS(HardwareMap hardwareMap, double x, double y, double heading) {
        drivetrain = new SampleMecanumDrive(hardwareMap);
        unit = RoadrunnerUnit.IN;
     ...
     */
    public RoadrunnerWrapperPS(HardwareMap hardwareMap, double x, double y, double heading, RoadrunnerUnit unit) {
        drivetrain = new SampleMecanumDrive(hardwareMap);
        this.unit = unit;
        startPose = new Pose2d(toInches(x), toInches(y), Math.toRadians(heading));
        drivetrain.setPoseEstimate(startPose);
     ...
     */
    public void build() {
        trajectorySequence = sequenceWrapperPS.trajectorySequenceBuilder.build();
    }
