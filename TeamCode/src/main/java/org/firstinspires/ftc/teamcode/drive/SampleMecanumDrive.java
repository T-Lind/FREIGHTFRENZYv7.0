...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(9, 0, 0); //used to be 2.45, 2.88
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(9.6, 0, 0); //used to be 1.45, 3.5
