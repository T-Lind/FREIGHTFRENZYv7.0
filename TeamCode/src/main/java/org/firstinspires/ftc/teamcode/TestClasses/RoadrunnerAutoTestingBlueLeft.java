...
public class RoadrunnerAutoTestingBlueLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(new Pose2d(-4, 46, Math.toRadians(-205)))
        ...
        TrajectorySequence traj5 = drive.trajectorySequenceBuilder(new Pose2d(61, 52, Math.toRadians(0)))
                .setReversed(true)
                .back(53)
